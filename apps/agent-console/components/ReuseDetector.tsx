...
const SAMPLE =
  "An agent discovers a service, reads its machine-readable metadata, and pays a fraction of a cent per request via x402, settled recursively through the citation lineage.";
    ...
    <div className="form">
      <div className="field">
        ...
        <span className="field-hint">
          We shingle the text and check containment against the source corpus — the same call the
          citation-toll sidecar exposes at <code>POST /attribution/detect</code>.
        </span>
      </div>
        ...
        <div style={{ marginTop: 8 }}>
          <div className="row-between" style={{ marginBottom: 10 }}>
            <span className={`badge ${result.grounded ? "badge-good" : "badge-neutral"}`}>
              {result.grounded ? "Grounded in the corpus" : "No grounding detected"}
            </span>
